...
const Footer = () => (
  ...
  const Categories = () => (
    <div className="col-span-1">
      <h3 className="font-josefin-sans text-[22px] leading-[25.78px] mb-10 font-bold text-[#151875]">Categories</h3>
  ...
  const CustomerCare = () => (
    <div className="col-span-1">
      <h3 className="font-josefin-sans text-[22px] leading-[25.78px] mb-10 font-bold text-[#151875]">Customer Care</h3>
      <ul className="font-lato font-normal text-base leading-[1.2] text-[#8A8FB9]">
        <li className="my-[20px] h-[20px]">
          <a href="#">My Account</a>
        </li>
  ...
  const Pages = () => (
    <div className="col-span-1">
      <h3 className="font-josefin-sans text-[22px] leading-[25.78px] mb-10 font-bold text-[#151875]">Pages</h3>
      <ul className="font-lato font-normal text-base leading-[1.2] text-[#8A8FB9]">
        <li className="my-[20px] h-[20px]">
          <a href="#">Blog</a>
        </li>
  ...
  const FooterForm = () => (
    <div className="col-span-1">
      <h3 className="font-josefin-sans text-[22px] leading-[25.78px] mb-10 font-bold text-[#151875]">Sign Up for Newsletter</h3>
      <form className="flex">
        <input
          type="email"
          placeholder="Email Address"
          className="px-5 py-[10px] w-[80%] text-[14px] rounded-[10px] text-gray-700 placeholder:text-[#8A8FB9] focus:outline-none"
        />
        <button
          type="submit"
          className="bg-pink-600 text-white font-lato font-normal text-base rounded-[10px] ml-[15px] px-[20px] py-[10px] hover:bg-pink-700"
        >
          Sign Up
        </button>
      </form>
